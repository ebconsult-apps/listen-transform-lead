...
/**
 * In-app worked example for signed-in users: the shared segment-specific
 * SampleReport fixtures with app chrome and an orientation banner, so a brand-new
 * user can see the exact shape of the deliverable without filling the New Project
 * form or waiting on a run. The `?segment=` param picks which buyer's challenge.
 */
const SampleProject = () => {
        ...
        <div className="flex items-start gap-3 mb-5">
          ...
          <div>
            ...
            <p className="body-md mt-2">
              ...
              Clarify, the free leverage teaser, and the full report — is real CLEAR output. Pick the
              version closest to your challenge.
            </p>
          </div>
        </div>
        <Pipeline />
