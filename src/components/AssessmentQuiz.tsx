...
const questions: Question[] = [
  ...
  {
    type: "scale",
    question: "When your organization sets out to change something, how clear is the shared understanding of what success looks like?",
    lowLabel: "Vague or conflicting views",
    highLabel: "Crystal clear, widely shared",
    key: "clarity",
  },
  {
    type: "scale",
    question: "How well does your organization understand the key dynamics and interdependencies that affect your ability to reach your goals?",
    lowLabel: "We mostly guess",
    highLabel: "Deep systemic understanding",
    key: "leverage",
  },
  {
    type: "scale",
    question: "When facing a complex challenge, how willing is your organization to test ideas on a small scale before committing fully?",
    lowLabel: "We plan big and commit",
    highLabel: "We prototype and iterate",
    key: "experimentation",
  },
  {
    type: "scale",
    question: "After implementing changes, how rigorously does your organization evaluate what actually worked and why?",
    lowLabel: "We move on quickly",
    highLabel: "Structured reflection is routine",
    key: "analysis",
  },
  {
    type: "scale",
    question: "How effectively does your organization turn lessons learned into lasting improvements in how you work?",
    lowLabel: "Insights rarely stick",
    highLabel: "Continuous improvement is embedded",
    key: "refinement",
  },
